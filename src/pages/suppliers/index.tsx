  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'store.count', 'tool.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['description.contains', 'address.contains', 'contact_number.contains', 'name.contains'],
          ...params.filters,
        },
        'supplier',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'contact_number', header: 'Contact Number', accessorKey: 'contact_number' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.opening_hours ? format(record?.opening_hours, 'dd-MM-yyyy') : '',
    },
    {
      id: 'closing_hours',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.closing_hours ? format(record?.closing_hours, 'dd-MM-yyyy') : '',
    },
